...
class Crop {
    ...
    public static function createCrop($name_crop_ua, $yield_min, $yield_max, $cleaning_qty, $drying_qty, $cleaning_price, $drying_price, $storing_price, $selling_price, $other_operating_1, $other_operating_2, $other_operating_3){
        $db = Db::getConnection();
        $db->query("INSERT INTO crop_head_veg (	name_crop_ua, yield_min, yield_max, cleaning_qty, drying_qty, cleaning_price, drying_price, storing_price, selling_price, other_operating_1, other_operating_2, other_operating_3)
    ...
    public static function getCropId($id){
        $db = Db::getConnection();
        $result = $db->query("SELECT * FROM crop_head_veg WHERE id_crop=$id");
        $result->setFetchMode(PDO::FETCH_ASSOC);
    ...
    public static function editSaveCrop($id, $name_crop_ua, $yield_min, $yield_max, $cleaning_qty, $drying_qty, $cleaning_price, $drying_price, $storing_price, $selling_price, $other_operating_1, $other_operating_2, $other_operating_3){
        $db = Db::getConnection();
        $db->query("UPDATE crop_head_veg SET name_crop_ua = '$name_crop_ua', yield_min = '$yield_min', yield_max = '$yield_max', cleaning_qty = '$cleaning_qty', drying_qty = '$drying_qty', cleaning_price = '$cleaning_price', drying_price = '$drying_price', storing_price = '$storing_price', selling_price = '$selling_price', other_operating_1 = '$other_operating_1', other_operating_2 = '$other_operating_2', other_operating_3 = '$other_operating_3'
                    WHERE id_crop = '$id'");
    ...
    public static function removeCrop($id){
        $db = Db::getConnection();
        $db->query("UPDATE crop_head_veg SET status_delete = '1' WHERE id_crop = $id");
