...
<!--                <li class="active"><a href="#activity" data-toggle="tab">Activity</a></li>-->
                <li class="active"><a href="#settings" data-toggle="tab">Налаштування профілю</a></li>
                <li><a href="#timeline" data-toggle="tab">Баланс</a></li>
            </ul>
                ...
                <div class="active tab-pane" id="settings">
                    <form method="post" action="/farmer/profile/save" class="form-horizontal">
                        <div class="form-group">
                            <label for="company_name" class="col-sm-4 control-label">Назва агрокомпанії, фермерського господарства</label>
                        ...
                        <div class="form-group">
                            <label for="specialization" class="col-sm-4 control-label">Cпеціалізація</label>
                        ...
                        <div id="region_in" class="form-group ">
                            <label for="region" class="col-sm-4 control-label">Місце здійснення діяльності</label>
