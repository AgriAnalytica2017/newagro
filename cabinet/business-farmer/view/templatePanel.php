<?php
$language=SRC::getLanguage('farmer');
$menu=array(
        'Поля'=>'/business-farmer/field',
        'Технологічні карти'=>'/business-farmer/technology_sheet',
        'user'=>'/business-farmer/user',
        'employee'=>'/business-farmer/employee',
        'name3'=>array(
            'name3_1'=>'/business-farmer',
            'name3_2'=>'/business-farmer',
            'name3_3'=>array(
                'name3_3_1'=>'/business-farmer',
                'name3_3_2'=>'/business-farmer',
                'name3_3_3'=>'/business-farmer',
            )
        ),
        'name4'=>'/business-farmer',
);
?>
<!DOCTYPE html>
    <html>
    <head>
        ...
        <link rel="stylesheet" href="<?php SRC::getSrc(); ?>/cabinet/business-farmer/template/css/style-farmer.css">
        ...
        <script type="text/javascript" src="<?php SRC::getSrc();?>/cabinet/business-farmer/template/js/script.js"></script>
        <script>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer" style="background: rgba(121, 162, 42, 0.3)!important;">
                                    ...
                                    <div class="">
                                        <a href="/business-farmer/login_off" class="btn btn-default btn-flat">change user</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                    ...
                    <? }else{?>
                            <li class="treeview" id="menu_1">
                                ...
                                <ul class="treeview-menu">
                                    <?foreach ($href as $name_1=>$href_1){
                                        $id_menu++;
                                        if(is_string($href_1)){?>
                                            <li id="<?=$id_menu?>"><a href="<?=$href_1?>"><?=$name_1?></a></li>
                                    <?}else{?>
                                            <li id="<?=$id_menu?>" >
                                                <a href="#"><?=$name_1?>
                                                    <span class="pull-right-container">
                                                ...
                                                <ul class="treeview-menu">
                                                    <? foreach ($href_1 as $name_1_1=>$href_1_1){$id_menu++ ?>
                                                    <li id="<?=$id_menu?>">
                                                        <a href="<?=$href_1_1?>"><i class="fa fa-link"></i><span><?=$name_1_1?></span></a>
                                                    </li>
                                                <?php } ?>
                                                </ul>
                                            </li>
