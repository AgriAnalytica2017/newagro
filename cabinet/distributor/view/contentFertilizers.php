        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Перелік доданих добрив</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="box-body">
                    ...
                    <table class="table table-condensed">
                        ...
                        <?php foreach ($date as $key) { ?>
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="/distributor/edit-fertilizers/<?php echo $key['id_material']; ?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></a>
                                    <a href="/distributor/remove-material/fertilizers/<?php echo $key['id_material']; ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-remove"></a>
                                </td>
                            </tr>
                        <?php }?>
                    </table>
