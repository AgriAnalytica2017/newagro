...
class Budget{
    ...
    public static function getTable(){
        ...
        $Ex_name=array(
            array(
                "name_php"=>"revenue",
                "name_ua"=>"Виручка від реалізації продукції, ".$valuta[$_COOKIE['lang']][$_COOKIE['currency']],
                "name_en"=>'Revenue from sale, '.$valuta[$_COOKIE['lang']][$_COOKIE['currency']],
                "class"=>"",
                "proc"=>"revenue",
            ...
            array(
                ...
                "name_ua"=>"Виробнича собівартість, {$valuta[$_COOKIE['lang']][$_COOKIE['currency']]}:",
                "name_en"=>"Operating cost, {$valuta[$_COOKIE['lang']][$_COOKIE['currency']]}:",
                "class"=>"",
                "proc"=>"total_cost",
                "href"=>""
            ),
            array(
                ...
                "name_ua"=>"Прямі матеріальні витрати, {$valuta[$_COOKIE['lang']][$_COOKIE['currency']]}:",
                "name_en"=>"Direct cost, {$valuta[$_COOKIE['lang']][$_COOKIE['currency']]}:",
                "class"=>"",
            ...
            array("name_php"=>"other_direct",
                "name_ua"=>"Інші прямі та загальновиробничі витрати, {$valuta[$_COOKIE['lang']][$_COOKIE['currency']]}:",
                "name_en"=>"Other direct and overhead costs, {$valuta[$_COOKIE['lang']][$_COOKIE['currency']]}:",
                "class"=>"level1",
                "proc"=>"production_cost",
                "href"=>""
            ),
    ...
    public static function transformToCashFlow($CF_Month){
        ...
        $CF_table=array(
            array(
                "name_php"=>"false",
                "name_ua"=>"1.Рух коштів в результаті операційної діяльності, {$valuta[$_COOKIE['lang']][$_COOKIE['currency']]}",
                "name_en"=>"Cash flow from operating activity, {$valuta[$_COOKIE['lang']][$_COOKIE['currency']]}",
                "class"=>""
            ),
            array(
            ...
            array(
                "name_php"=>"",
                "name_ua"=>"в тому числі нові відсотки по кредиту",
                "name_en"=>"",
                "class"=>"level2"
            ),
            array(
            ...
            array(
                "name_php"=>"",
                "name_ua"=>"погашення позик",
                "name_en"=>"",
                "class"=>"level2 close3"
            ),
            array(
                "name_php"=>"",
                "name_ua"=>"погашення нових позик",
                "name_en"=>"",
                "class"=>"level2 close3"
            ),
            array(
                "name_php"=>"",
                "name_ua"=>"погашення інших надходжень",
                "name_en"=>"",
                "class"=>"level2 close3"
            ),
            array(
            ...
            array(
                ...
                "name_ua"=>"Залишок коштів на початок року",
                "name_en"=>"",
                "class"=>""
            ),
            array("name_php"=>"remaining_end",
                "name_ua"=>"Залишок коштів на кінець року",
                "name_en"=>"",
                "class"=>""
            ),
        );
    ...
    public static function saveSettingCashFlow($sql_save){
        $db = Db::getConnection();
        $id_user = $_SESSION['id_user'];
        $db->query("DELETE FROM cash_flow WHERE id_user=$id_user");
...
//        $db->query("INSERT INTO financial (user_id, data_fin) VALUE ('$id', '$save')");
    ...
    public static function getTableFinancial(){
        $Ex_name[]=array("name_php"=>1, "name_ua"=>"Урожайність культур, ц/га","name_en"=>"",);
        $Ex_name[]=array("name_php"=>2, "name_ua"=>"Ціна реалізації, грн/т","name_en"=>"",);
        $Ex_name[]=array("name_php"=>3, "name_ua"=>"Виручка від реалізації продукції, грн/га","name_en"=>"",);
        $Ex_name[]=array("name_php"=>4, "name_ua"=>"Чистий прибуток, грн/га","name_en"=>"",);
        $Ex_name[]=array("name_php"=>5, "name_ua"=>"Виробнича собівартість, грн/т","name_en"=>"",);
        $Ex_name[]=array("name_php"=>6, "name_ua"=>"Виробнича собівартість, грн/га","name_en"=>"",);
        $Ex_name[]=array("name_php"=>7, "name_ua"=>"Повна собівартість, грн/т","name_en"=>"",);
        $Ex_name[]=array("name_php"=>8, "name_ua"=>"Повна собівартість, грн/га","name_en"=>"",);
        $Ex_name[]=array("name_php"=>9, "name_ua"=>"Поріг беззбиткової урожайності, ц/га","name_en"=>"",);
        //$Ex_name[]=array("name_php"=>10,"name_ua"=>"Поріг прибуткової урожайності, ц/га");
        $Ex_name[]=array("name_php"=>11,"name_ua"=>"Операційний прибуток (EBIT), грн/т","name_en"=>"",);
        $Ex_name[]=array("name_php"=>12,"name_ua"=>"Операційний прибуток (EBIT), грн/га","name_en"=>"",);
        $Ex_name[]=array("name_php"=>13,"name_ua"=>"EBITDA, грн/га","name_en"=>"",);
        $Ex_name[]=array("name_php"=>14,"name_ua"=>"Маржинальний прибуток, грн/га","name_en"=>"",);
        $Ex_name[]=array("name_php"=>15,"name_ua"=>"Маржинальний прибуток, %","name_en"=>"",);
        $Ex_name[]=array("name_php"=>16,"name_ua"=>"Рентабельність виробництва, %","name_en"=>"",);
        $Ex_name[]=array("name_php"=>17,"name_ua"=>"Рентабельність продажів, %","name_en"=>"",);
        return $Ex_name;
    }
    //исторический анализ
