...
<div class="col-xs-12">
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title"><?=$language['farmer']['89'];?></h3>
            <div class="box-tools">
        ...
        <div class="box-body">
            <table class="table">
                ...
                <tr>
                    <th class="text-center" colspan="5"><h3><?=$language['farmer']['92'];?></h3></th>
                </tr>
                <tr>
                    <th class="text-center"><?=$language['farmer']['83'];?></th>
                    <th class="text-center"><?=$language['farmer']['85'];?></th>
                ...
                <tr>
                    <th class="text-center" colspan="5"><h3><?=$language['farmer']['93'];?></h3></th>
                </tr>
                <tr>
                    <th class="text-center"><?=$language['farmer']['83'];?></th>
                    <th class="text-center"><?=$language['farmer']['85'];?></th>
                ...
                <tr>
                    <th class="text-center" colspan="5"><h3><?=$language['farmer']['94'];?></h3></th>
                </tr>
                <tr>
                    <th class="text-center"><?=$language['farmer']['83'];?></th>
                    <th class="text-center"><?=$language['farmer']['85'];?></th>
