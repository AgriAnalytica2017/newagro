...
class EquipmentController{
    ...
    public function actionCreateEquipment(){
        ...
        Equipment::createEquipment($id_user,$equipment_name,$equipment_type,$equipment_capacity,$equipment_width,$equipment_aquisition,$equipment_price,$equipment_usage,$equipment_unit,$equipment_kind);
    ...
    public function actionEditEquipment(){
        ...
        Equipment::editEquipment($id_equipment,$id_user,$equipment_name,$equipment_type,$equipment_capacity,$equipment_width,$equipment_aquisition,$equipment_price,$equipment_usage, $equipment_unit,$equipment_kind);
        SRC::redirect('/new-farmer/equipment');
        return true;
    }
