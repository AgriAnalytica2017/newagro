...
class StorageController{
	...
	public function actionCreateStorage(){
        ...
        $storage_type =2;
		$storage_material_id = Storage::createStorage($id_user,$storage_type_material,$storage_material,$storage_quantity,$storage_sum_total,$storage_date, $storage_id, $storage_comments);
