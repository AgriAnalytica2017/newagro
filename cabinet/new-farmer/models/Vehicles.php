...
class Vehicles{
    ...
    public static function createVehicles($id_user,$vehicles_kind, $vehicles_name, $vehicles_license,$vehicles_inventory_number,$vehicles_fuel_type, $vehicles_fuel, $vehicles_acquisition, $vehicles_power, $vehicles_load_capacity, $vehicles_depreciation, $vehicles_amount_of_amortization,$vehicles_usage_year,$vehicles_purchase_price){
        $db = Db::getConnection();
        $db->query("INSERT INTO new_vehicles(id_user, vehicles_kind, vehicles_name, vehicles_license,vehicles_inventory_number,vehicles_type_fuel, vehicles_fuel, vehicles_acquisition, vehicles_power,vehicles_load_capacity, vehicles_depreciation, vehicles_amount_of_amortization,vehicles_usage_year,vehicles_purchase_price) 
            VALUES ('$id_user','$vehicles_kind', '$vehicles_name','$vehicles_license','$vehicles_inventory_number','$vehicles_fuel_type','$vehicles_fuel','$vehicles_acquisition', '$vehicles_power','$vehicles_load_capacity', '$vehicles_depreciation', '$vehicles_amount_of_amortization', '$vehicles_usage_year','$vehicles_purchase_price')");
        return true;
    }
