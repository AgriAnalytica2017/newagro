...
Технологія на вирощування <?=mb_strtolower($date['only_tech']['name_for_tech_head'],'UTF-8');?>
        </div>
</div>
<div class="box-bodyn col-lg-12">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content wt">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <input class="inphead searchs" id="search_equipment" type="text" placeholder="Поиск" style="float: left">
                        <button type="button" class="btn btn-primary" style="float: right" data-dismiss="modal"><?=$language['new-farmer']['27']?></button>
                    </div>
                </div><br>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="bd_materials">
                                ...
                                <select class="form-control inphead"  id="type_material_list_bd">
                            ...
                            <div class="tab-pane" id="new_materials">
                                <form method="post" id="material_form" action="javascript:void(null);">
                                    ...
                                    <select class="form-control id_type_material inphead" name="id_type_material">
                                        <option value="1"><?=$language['new-farmer']['90']?></option>
                                        <option value="2"><?=$language['new-farmer']['91']?></option>
                                        <option value="3"><?=$language['new-farmer']['92']?></option>
                                    </select>
                                    ...
                                    <div class="sub_type_seed">
                                        ...
                                        <input class="form-control inphead" value="<?=$date['only_tech']['name_crop_ua']?>" disabled>
                                    </div>
                                    <div class="sub_type_ppa" style="display: none">
                                        <label><?=$language['new-farmer']['97']?></label>
                                        <select class="form-control inphead" name="key_material_3" id="key_material_3">
                                    ...
                                    <div class="sub_type_fert" style="display: none">
                                        <label><?=$language['new-farmer']['97']?></label>
                                        <select class="form-control inphead" name="key_material_2" id="key_material_2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <select name="unit_material" id="unit_material"  class="form-control inphead unit_material">
                                        ...
                                        <!--<div class="col-lg-6">
                                            ...
                                            <input type="text" name="price_material" id="price_material" class="form-control inphead">
                                        </div>-->
                                        <div class="col-lg-6">
...
<!--<div id="select_fuel" style="display:none;">
    <select class="form-control inphead id_fuel">
    ...
    $(document).ready(function(){
        ...
        function add_services() {
            ...
            $('#action_services').append("<tr class='action_services' id='action_services_"+id_services+"'>" +
                "<td><input  class='name form-control  inphead' type='text'></td>" +
                "<td><input data-id='"+id_services+"' id='s_amount"+id_services+"' class='amount form-control  inphead in_services' type='text' value='"+total_work+"'></td>" +
                "<td><input data-id='"+id_services+"' id='s_price"+id_services+"' class='price form-control inphead in_services' type='text'></td>" +
        ...
        function add_material() {
            ...
            $("#action_material").append("<tr id='action_material_" + id_material + "'>" +
                ...
                "<td><input data-id='"+material['id_material_price']+"' type='text' class='form-control inphead norm_material' ></td>" +
            ...
            $.ajax({
                ...
                success: function(id_bd_material){
                    $("#action_material").append("<tr id='action_material_" + id_material + "'>" +
                        ...
                        "<td><input data-id='"+id_bd_material+"' type='text' class='form-control inphead norm_material' value='"+norm+"' ></td>" +
                        "<td><button class='btn btn-danger btn-sm remove_material' data-id='" + id_material + "' ><i class='fa fa-fw fa-close'></i></button></td>" +
                        "</tr>");
                }
            });
        ...
        function add_vehicles() {
            ...
            $("#action_vehicles").append("<tr class='equipment_id' id='action_vehicles_"+id_vehicles+"'>" +
                ...
                "</div>" +
                "</td>" +
                "<td><input type='text'  class='form-control fuel inphead'></td>" +
        ...
        function open_edit() {
            ...
            $.each(services, function(key, value) {
                id_services++;
                $('#action_services').append("<tr class='action_services' id='action_services_"+id_services+"'>" +
                    "<td><input  class='name form-control  inphead' type='text' value='"+value['name']+"'></td>" +
                    "<td><input data-id='"+id_services+"' id='s_amount"+id_services+"' class='amount form-control inphead in_services' type='text' value='"+value['amount']+"'></td>" +
                    "<td><input data-id='"+id_services+"' id='s_price"+id_services+"' class='price form-control inphead in_services' type='text' value='"+value['price']+"'></td>" +
            ...
            if(isNaN(material)){
                $.each(material, function(key, value) {
                    ...
                    $("#action_material").append("<tr id='action_material_" + id_material + "'>" +
                        ...
                        "<td><input data-id='"+material['id']+"' value='"+material['norm']+"' type='text' class='form-control inphead norm_material' ></td>" +
                        "<td><button class='btn btn-danger btn-sm remove_material' data-id='" + id_material + "' ><i class='fa fa-fw fa-close'></i></button></td>" +
                        "</tr>");
                });
            }
            ...
            $.each(equipment, function(key, value) {
                ...
                $("#action_vehicles").append("<tr class='equipment_id' id='action_vehicles_"+id_vehicles+"'>" +
                    ...
                    "</div>" +
                    "</td>" +
                    "<td><input type='text' class='form-control fuel inphead' value='"+vehicles['fuel']+"'></td>" +
                    "<td><button class='btn btn-danger btn-sm remove_vehicles' data-id='"+id_vehicles+"' ><i class='fa fa-fw fa-close'></i></button></td>" +
                    "</tr>");
            });
            save_vehicles();
