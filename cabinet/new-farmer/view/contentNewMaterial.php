...
<!--            <hr>-->
            ...
            <table class="table box-bodyn col-lg-12">
                <thead>
                    <tr>
                        <th>Тип матеріалу</th>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <select id="type_materia" class="inphead form-control" name="type_material">
                            <?php foreach ($date['type_material']['ua'] as $key=>$value){?>
                                <option value="<?=$key?>"><?=$value?></option>
                            <?} ?>
                        </select>
                        ...
                        <select id="sub_type_material_seed" class="inphead form-control" name="sub_type_material_seed">
                            <? foreach ($date['crop_list'] as $crop_list){?>
                                <option value="<?=$crop_list['id_crop']?>"><?=$crop_list['name_crop_ua']?></option>
                            <?}?>
                        </select>
                        <select id="sub_type_material_ppa" class="inphead form-control" name="sub_type_material_ppa" style="display: none">
                            <?php foreach ($date['ppa_material']['ua'] as $key=>$value){?>
                                <option value="<?=$key?>"><?=$value?></option>
                            <?} ?>
                        </select>
                        <select id="sub_type_material_fert" class="inphead form-control" name="sub_type_material_fert" style="display: none">
                            <option value="1">Мінеральні</option>
                            <option value="2">Органічні</option>
                        </select>
                        <select id="sub_type_material_fuel" class="inphead form-control" name="sub_type_material_fuel" style="display: none">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input list="lib_materials" class="inphead form-control" name="name_material" id="name_material" >
                        ...
                        <input type="text" name="price_material" id="price_material" class="inphead form-control">
                    </div>
                </div>
                <br>
                <div class="text-center">
                <button type="submit" class="btn btn-success " id="add_material_bd">Зберегти</button>
                    </div>
                </form>
            </div>
        </div>
