<section class="content">
    <form class="form-horizontal" action="/distributor/create-ppa" method="post">
        <div class="row">
            <!-- left column -->
            <div class="col-md-9">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Додавання нового засобу захисту рослин</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control select2" id="material_subtype" name="material_subtype" style="width: 100%;">
                                    <?php foreach ($date['subtype'] as $key) {?>
                                        <option <?php //if($key['id_crop'] == '9') echo 'selected';?> value="<?php echo $key['id_subtype'];?>"><?php echo $key['name_subtype_ua'];?></option>
                                    <?php }?>
                                </select>
                            </div>
                        </div>
