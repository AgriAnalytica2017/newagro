...
<section class="content">
    <form class="form-horizontal" action="/distributor/save-seeds" method="post">
        <div class="row">
            <!-- left column -->
            <div class="col-md-9">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Редагування насіння</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <div class="radio">
                                    <label>
                                        <input  type="radio" name="optionsRadios" id="optionsRadios1" class="cg" value="11" checked> кг/га
                                    </label> &nbsp;
                                    <label>
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="save_rec_qty" class="form-control po" id="save_rec_qty" placeholder="Норма висіву" value="<?php echo $date['dateSeed'][0]['save_rec_qty'];?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="save_1po_seeds" class="form-control po" id="save_1po_seeds" placeholder="Кіл. насінин" value="<?php echo $date['dateSeed'][0]['save_1po_seeds'];?>">
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="save_m_1000" class="form-control po" id="save_m_1000" placeholder="Маса насінин" value="<?php echo $date['dateSeed'][0]['save_m_1000'];?>">
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="save_price_pdv" class="col-sm-4 control-label ">Ціна з ПДВ, грн/п.од/т</label>

                        <div class="col-sm-5">
                            <input type="text" name="save_price_pdv" class="form-control po" id="save_price_pdv" placeholder="Ціна" value="<?php echo $date['dateSeed'][0]['save_price_pdv'];?>">
                        </div>
                    </div>
                    </span>
