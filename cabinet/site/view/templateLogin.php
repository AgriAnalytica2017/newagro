...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="/singnin" method="post">
...
<!--                </div>-->
        ...
        <a href="recover"  class="text-center down">Я забув свій пароль</a><br>
        <a href="register" <?= $_SERVER["REQUEST_URI"] == '/contact' ? 'class="active"' : '' ?><?= $t['16'] ?> class="text-center">Зареєструватися</a>
